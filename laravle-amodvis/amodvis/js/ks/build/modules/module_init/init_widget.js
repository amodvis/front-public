...
modules/module_init/init_widget_base
modules/module_init/init_widget

*/
KISSY.add('modules/module_init/init_widget_base', function (S, Node, Slide, Switchable, DD) {
    var $ = Node.all;
    var self = {
        init: function () {
        },
    ...
    return self;
        ...
        requires: ["node", "kg/slide/2.0.0/base", "gallery/switchable/1.3.1/index", "dd"]
    });
